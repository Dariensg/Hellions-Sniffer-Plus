...
public class NeoForgeWoodTypeHelper implements IWoodTypeHelper {
    @Override
    public WoodType registerWoodType(String identifier, BlockSetType setType, SoundType soundType, SoundType hangingSignSoundType, SoundEvent fenceGateClose, SoundEvent fenceGateOpen) {
        return WoodType.register(new WoodType(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, identifier).toString(), setType, soundType, hangingSignSoundType, fenceGateClose, fenceGateOpen));
    }
}
